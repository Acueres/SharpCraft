...
namespace SharpCraft.Menu
{
    class GameMenu
    {
        ...
        void DrawDebugScreen(int fps)
        {
            ...
            spriteBatch.DrawString(font14, $"CX: {FullChunk.CalculateChunkIndex(player.Position.X)}, CY: {FullChunk.CalculateChunkIndex(player.Position.Y)}, CZ: {FullChunk.CalculateChunkIndex(player.Position.Z)}", new Vector2(10, 90), Color.White);
        }
    }
}
